---
name: probe-channel-skill
description: Diagnostic probe reporting which channels reached it at spawn. Declares the canary skill in its skills field. Installed and removed by run-probes.sh. Not for general use.
tools: WebSearch
model: haiku
maxTurns: 2
